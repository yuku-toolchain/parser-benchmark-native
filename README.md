...
|--------|--------|-----|-----|----|
| Yuku | 26.73 ms | 23.47 ms | 53.00 ms | 40.7 MB |
| Oxc | 29.72 ms | 25.74 ms | 31.62 ms | 52.7 MB |
| SWC | 59.52 ms | 50.20 ms | 72.18 ms | 88.9 MB |
...
| Parser | Median | Min | Max | Peak Memory (RSS) |
|--------|--------|-----|-----|----|
| Yuku | 6.56 ms | 6.46 ms | 7.19 ms | 11.5 MB |
| Oxc | 7.02 ms | 6.43 ms | 28.71 ms | 13.4 MB |
| SWC | 11.53 ms | 11.26 ms | 15.83 ms | 21.4 MB |
...
| Parser | Median | Min | Max | Peak Memory (RSS) |
|--------|--------|-----|-----|----|
| Oxc | 1.17 ms | 1.13 ms | 1.92 ms | 2.3 MB |
| Yuku | 1.22 ms | 1.18 ms | 2.37 ms | 2.0 MB |
| SWC | 1.52 ms | 1.44 ms | 3.30 ms | 3.1 MB |
...
| Parser | Median | Min | Max | Peak Memory (RSS) |
|--------|--------|-----|-----|----|
| Yuku + Semantic | 46.21 ms | 40.24 ms | 49.94 ms | 88.9 MB |
| Oxc + Semantic | 58.99 ms | 58.39 ms | 72.87 ms | 92.5 MB |
...
| Parser | Median | Min | Max | Peak Memory (RSS) |
|--------|--------|-----|-----|----|
| Yuku + Semantic | 9.83 ms | 9.72 ms | 10.91 ms | 21.4 MB |
| Oxc + Semantic | 12.39 ms | 12.24 ms | 13.92 ms | 21.8 MB |
...
| Parser | Median | Min | Max | Peak Memory (RSS) |
|--------|--------|-----|-----|----|
| Yuku + Semantic | 1.38 ms | 1.34 ms | 1.94 ms | 3.1 MB |
| Oxc + Semantic | 1.48 ms | 1.44 ms | 3.42 ms | 3.1 MB |
